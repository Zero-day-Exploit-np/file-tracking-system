...
<div class="portal-form-card">
    <form method="POST" action="{{ route('admin.designations.update', $designation->uuid) }}" class="portal-form">
        ...
        <div class="row g-3">
            ...
            {{-- Department: editable for Super Admin --}}
            ...
            <div class="col-md-6">
                ...
                <input type="text" class="form-control"
                    value="{{ $designation->department->name ?? 'N/A' }}" readonly>
            </div>
            @endif
            ...
            <div class="col-md-4">
                ...
                <select name="status" class="form-select">
                    <option value="1" {{ old('status', $designation->is_active ? '1' : '0') == '1' ? 'selected' : '' }}>Active</option>
                    <option value="0" {{ old('status', $designation->is_active ? '1' : '0') == '0' ? 'selected' : '' }}>Inactive</option>
                </select>
            </div>
